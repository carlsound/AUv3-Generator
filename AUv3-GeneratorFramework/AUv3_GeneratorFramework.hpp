...
//! Project version number for AUv3_GeneratorFramework.
FOUNDATION_EXPORT double AUv3_GeneratorFramework_VersionNumber;

//! Project version string for AUv3_GeneratorFramework.
FOUNDATION_EXPORT const unsigned char AUv3_GeneratorFramework_VersionString[];
